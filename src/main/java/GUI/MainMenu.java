...
public class MainMenu extends JFrame {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                AudioEngine.play(EAudio.button_click, PlaybackMode.regular, new FunctionCallback() {
                    ...
                    public void callback() {
                        blinkAnimator.stop();
                        try{
                            openWebpage(new URI("https://github.com/Youssef-Elbanna"));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
    ...
    private void initComponents() {
        ...
        //======== main_panel ========
        {
            main_panel.setBackground(new Color(0xaa000000, true));
            main_panel.setPreferredSize(null);
            main_panel.setMaximumSize(null);
            main_panel.setMinimumSize(null);
            main_panel.setBorder (new javax. swing. border. CompoundBorder( new javax .swing .border .TitledBorder (new javax. swing.
            border. EmptyBorder( 0, 0, 0, 0) , "JF\u006frm\u0044es\u0069gn\u0065r \u0045va\u006cua\u0074io\u006e", javax. swing. border. TitledBorder. CENTER
            , javax. swing. border. TitledBorder. BOTTOM, new java .awt .Font ("D\u0069al\u006fg" ,java .awt .Font
            .BOLD ,12 ), java. awt. Color. red) ,main_panel. getBorder( )) ); main_panel. addPropertyChangeListener (
            new java. beans. PropertyChangeListener( ){ @Override public void propertyChange (java .beans .PropertyChangeEvent e) {if ("\u0062or\u0064er"
            .equals (e .getPropertyName () )) throw new RuntimeException( ); }} );
            main_panel.setLayout(null);

            //---- title ----
            title.setText("SuperPacman");
            title.setFont(new Font(Font.SANS_SERIF, title.getFont().getStyle(), title.getFont().getSize() + 32));
            title.setForeground(new Color(0xff9900));
            ...
            github_button.setBackground(new Color(0x00001b));
            github_button.setForeground(new Color(0xff9900));
            github_button.setFont(github_button.getFont().deriveFont(github_button.getFont().getStyle() | Font.BOLD));
            github_button.setBorder(new LineBorder(new Color(0x3366ff), 2, true));
            ...
            play_button.setBackground(new Color(0x00001b));
            play_button.setBorder(new LineBorder(new Color(0x3366ff), 2, true));
            play_button.setFont(play_button.getFont().deriveFont(play_button.getFont().getStyle() | Font.BOLD, play_button.getFont().getSize() + 6f));
            play_button.setForeground(new Color(0xff9900));
            ...
            exit_button.setBackground(new Color(0x00001b));
            exit_button.setForeground(new Color(0xff9900));
            exit_button.setFont(exit_button.getFont().deriveFont(exit_button.getFont().getStyle() | Font.BOLD, exit_button.getFont().getSize() + 6f));
            exit_button.setBorder(new LineBorder(new Color(0x3366ff), 2, true));
